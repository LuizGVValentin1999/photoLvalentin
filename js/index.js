  ...
  observeParents: true,
   ...
   $(function(){
    ...
    $('.contact-link-about').on('click',function(){
     ...
     $('.home-link').on('click',function(){
      gsap.to('.roles-project',.5,{scale:.9});
      gsap.to('.roles-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.roles-project',0,{display:'none',delay:.7});
      gsap.to('.leads-project',.5,{scale:.9});
      gsap.to('.leads-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.leads-project',0,{display:'none',delay:.7});
      gsap.to('.barbershop-project',.5,{scale:.9});
      gsap.to('.barbershop-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.barbershop-project',0,{display:'none',delay:.7});
      gsap.to('.park-night-project',.5,{scale:.9});
      gsap.to('.park-night-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.park-night-project',0,{display:'none',delay:.7});
      gsap.to('#about',.5,{scale:.9});
      gsap.to('#about',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#about',0,{display:'none',delay:.7});
    ...
    $('.park-night-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.park-night-project',0,{display:'block',delay:.7})
      gsap.to('.park-night-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.barbershop-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.barbershop-project',0,{display:'block',delay:.7})
      gsap.to('.barbershop-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.leads-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.leads-project',0,{display:'block',delay:.7})
      gsap.to('.leads-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.roles-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.roles-project',0,{display:'block',delay:.7})
      gsap.to('.roles-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    ...
    $('.park-night-close').on('click',function(){
      gsap.to('.park-night-project',.5,{scale:.9});
      gsap.to('.park-night-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.park-night-project',0,{display:'none',delay:.7});
      gsap.to('#home',0,{display:'block',delay:.7})
    ...
    $('.barbershop-close').on('click',function(){
      gsap.to('.barbershop-project',.5,{scale:.9});
      gsap.to('.barbershop-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.barbershop-project',0,{display:'none',delay:.7});
      gsap.to('#home',0,{display:'block',delay:.7})
